"""
Django settings for nexisconnect_connect project.
...
SECRET_KEY = 'django-insecure-f3)_*hd^9&ep$rsm24^d!g*r7zi58l4qvb%s!3q9z!$&y2f&^h'
...
ROOT_URLCONF = 'nexisconnect_connect.urls'
...
WSGI_APPLICATION = 'nexisconnect_connect.wsgi.application'
